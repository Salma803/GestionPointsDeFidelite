...
function CreerProduit() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    ean2: Yup.string(),
    prix: Yup.number().min(0.1, "Le prix doit être supérieur à 0").required("Le prix est obligatoire"),
  ...
  const onSubmit = async (data, { setSubmitting, setFieldError }) => {
    try {
      const response = await axios.post(
        "http://localhost:3001/produit/creerproduits",
        data,
      );
            ...
            <div className='client-cf-screen__content'>
                  <div className="mb-3">
                    ...
                    <Field
                      ...
                      className={`form-control ${validationSchema.fields.nom.validate ? 'required-field' : ''}`}
                    />
                    <ErrorMessage
                      name="nom"
                      component="div"
                  ...
                  <div className="mb-3">
                    <label htmlFor="ean1" className="form-label">
                      EAN1 :
                    </label>
                    <Field
                      id="ean1"
                  ...
                  <div className="mb-3">
                    <label htmlFor="ean2" className="form-label">
                      EAN2 :
                    </label>
                    <Field
                      id="ean2"
...
/>
                  ...
                  <div className="mb-3">
                    <label htmlFor="id_rayon" className="form-label">
                      Rayon :
                    </label>
                    <Field as="select" name="id_rayon"                       className={`form-control ${validationSchema.fields.nom.validate ? 'required-field' : ''}`}
                    >
                  ...
                  <div className="mb-3">
                    <label htmlFor="valeur_promotion" className="form-label">
                      Valeur Promotion : 
                    </label>
                    <Field
                      id="valeur_promotion"
