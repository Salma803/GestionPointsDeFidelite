					...
					<Row className="no-gutters">
						...
						<Col md={8}>
							<Card.Body>
								...
								<Card.Text>
									Code Produit : {produit.ean1}
								</Card.Text>
								{produit.active ? (
									<div>
										<Card.Text>
											Prix Original :{" "}
											{produit.prixAvantSolde} DH
										</Card.Text>
										<Card.Text>
											Promotion : {produit.valeurSolde}%
										</Card.Text>
										<Card.Text>
											Prix Actuel :{" "}
											{produit.prixApresSolde} DH
										</Card.Text>
										<Card.Text>
											Date de Fin de Promotion :{" "}
											{new Date(
												produit.dateFinPromo
											).toLocaleDateString()}
										</Card.Text>
									</div>
								) : (
