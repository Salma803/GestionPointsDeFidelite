            ...
            <Container className='NavBar-container' fluid>
                ...
                <Navbar.Collapse id="navbar-dark-example">
                    <Nav className="me-auto">
                        ...
                        <Nav.Link onClick={updateLoyaltyCard}><IdentificationCard size={32} color="#3c43af" /></Nav.Link>
                        <Nav.Link onClick={navigateChequeCadeau}><Gift size={32} color='#3C43AF' /></Nav.Link>
