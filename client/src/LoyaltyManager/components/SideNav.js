    ...
    <nav className="mt-2">
      <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li className="nav-item menu-open">
          <a href="/loyaltymanager/home" className="nav-link active">
        ...
        <li className="nav-item">
          <a href='/loyaltymanager/creerclient' className="nav-link">
        ...
        <li className="nav-item">
          <a href="/loyaltymanager/listeclients" className="nav-link">
        ...
        <li className="nav-item">
          <a href="/loyaltymanager/cartefidelite" className="nav-link">
            <i className="nav-icon fas fa-edit" />
            <p>
              Carte Fidélité
        ...
        <li className="nav-item">
          <a href="/loyaltymanager/chequecadeau" className="nav-link">
            <i className="nav-icon fas fa-edit" />
            <p>
              Chéques Cadeaux
            </p>
        ...
        <li className="nav-item">
          <a href="/loyaltymanager/reclamations" className="nav-link">
        ...
        <li className="nav-item">
          <a href="/loyaltymanager/info" className="nav-link">
